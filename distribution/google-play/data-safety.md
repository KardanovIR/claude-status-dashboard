...
Google Play Data safety declaration for **AgStatus Android** (`com.kardanov.agstatus`, versionName 1.4.2). Every answer below is derived from the Android source in this repo, not from the iOS app.
